function [age,gender,country,OCEAN] = importfile(filename, startRow, endRow)
...
source = dataArray{:, 6};
country = dataArray{:, 7};
OCEAN(3) = aggregate(dataArray{:, 16});
OCEAN(5) = aggregate(dataArray{:, 18});
OCEAN(4) = aggregate(dataArray{:, 35});
OCEAN(2) = aggregate(dataArray{:, 40});
OCEAN(1) = aggregate(dataArray{:, 56});
