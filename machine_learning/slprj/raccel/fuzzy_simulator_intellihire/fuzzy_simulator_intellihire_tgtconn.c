...
) ; terminateToAsyncQueueTgtAppSvc ( ) ; } EXTERN_C void TgtConnPreStep (
int_T tid ) { tunePendingParameterChanges ( rt_modelMapInfoPtr ) ; } EXTERN_C
void TgtConnPostStep ( int_T tid ) { }
