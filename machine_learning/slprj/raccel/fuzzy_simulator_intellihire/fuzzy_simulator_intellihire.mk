...
MAKECMD         = /media/data_warehouse/software/matlab/bin/glnxa64/gmake
HOST            = UNIX
BUILD           = yes
...
MODEL                  = fuzzy_simulator_intellihire
MODULES                = fuzzy_simulator_intellihire_capi.c fuzzy_simulator_intellihire_data.c fuzzy_simulator_intellihire_tgtconn.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_nonfinite.c rtw_modelmap_utils.c 
MAKEFILE               = fuzzy_simulator_intellihire.mk
MATLAB_ROOT            = /media/data_warehouse/software/matlab
ALT_MATLAB_ROOT        = /media/data_warehouse/software/matlab
MATLAB_ROOTQ           = \"/media/data_warehouse/software/matlab\"
MASTER_ANCHOR_DIR      = 
START_DIR              = /media/data_warehouse/research/devel/burda_hackaday/machine_learning
...
COMPUTER               = GLNXA64
BUILDARGS              =  RSIM_SOLVER_SELECTION=2 PCMATLABROOT="/media/data_warehouse/software/matlab" EXT_MODE=1 ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DSLMSG_ALLOW_SYSTEM_ALLOC -DTGTCONN -DON_TARGET_WAIT_FOR_START=0"
...
MODELLIB                  = fuzzy_simulator_intellihirelib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/slprj/raccel/fuzzy_simulator_intellihire \
	-I$(START_DIR) \
